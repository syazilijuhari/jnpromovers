                ...
                <div class="container">
                    <div class="col-md-12">
                        <div class="text-center">
                            <img src="{{asset('img/jnpro-logo.png')}}" alt="JN Pro Logo" class="img-fluid img" style="width: 170px; height: 230px">
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <ul class="list-unstyled">
                                ...
                                <li class="text-muted">Phone No:  <span style="color:#5d9fc5 ;">{{$order->phone}}</span></li>
                            </ul>
                        </div>
                        <div class="col-xl-4">
                            <ul class="list-unstyled">
