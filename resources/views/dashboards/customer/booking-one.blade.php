        ...
        <section id="transportation">
            ...
            <div class="content booking-transportation">
                <div class="container text-center mt-4 mb-3">
                    <div class="row gx-4">
                        <div class="col-auto">
                            <input type="radio" class="btn-check btn-transport btn-lg" name="transport" id="lorry-1tan"
                                   autocomplete="off">
                            <label class="btn btn-outline-danger btn-transport btn-lg" for="lorry-1tan">1 Ton Lorry</label>
                        </div>

                        <div class="col-auto">
                            <input type="radio" class="btn-check btn-transport btn-lg" name="transport" id="lorry-3tan"
                                   autocomplete="off">
